...
const dashboards = {
  ...
  default: lazy(() => import('views/dashboards/DashboardsAnalytic')),
...
const apps = {
  ...
  holidays: lazy(() => import('views/blocks/tabulardata/TabularData')),
...
const routesAndMenuItems = {
  mainMenuItems: [
    ...
    {
      path: `${appRoot}/leave_request`,
      component: interfaces.forms.validation,
      label: 'Leave Request',
      icon: 'notebook-1',
    },
    // {
    //   path: `${appRoot}/holidays`,
    //   label: 'menu.holidays',
    //   icon: 'bookmark',
    //   component: apps.holidays,
